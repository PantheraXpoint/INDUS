...
def tree_search(
    ...
    tree_search = TreeSearch(query, llm, video, events_vdb, entities_vdb, features_vdb, retrieval_mode=retrieval_mode, initial_events_result=initial_events_result)
